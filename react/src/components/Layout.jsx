        ...
        <div className="navbar bg-base-100/70 backdrop-blur-md shadow-xl rounded-2xl px-2 sm:px-4 border border-base-content/10">
          ...
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-lg bg-base-100/90 backdrop-blur-md rounded-box w-56 border border-base-content/10">
                <li>
                ...
                <li>
                  <Link to="/flood" className={isActive('/flood') ? 'active' : ''}>
