  ...
  return (
    <div className="h-screen flex flex-col bg-base-200">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {coordinates && (
          <div className="absolute left-2 sm:left-4 top-2 sm:top-4 z-30 bg-base-100/90 backdrop-blur-sm px-1.5 sm:px-2.5 py-1 sm:py-1.5 rounded text-[10px] sm:text-xs font-mono border border-base-content/20 shadow-lg">
            {coordinates}
          </div>
        )}

        {/* Side Panel Toggle - Left Side */}
        <button
          className={`absolute left-2 sm:left-4 top-12 sm:top-16 z-30 btn btn-xs sm:btn-sm btn-square ${showSidePanel ? 'btn-active' : ''}`}
        ...
        {showSidePanel && sidePanel && (
          <div className="absolute left-0 top-0 bottom-0 w-full sm:w-64 md:w-72 bg-base-100 border-r border-base-content/10 shadow-xl z-20 overflow-y-auto">
        ...
        {/* Timeline Bar */}
        {timelineData && (
          <div className="absolute bottom-0 left-0 right-0 bg-base-100/95 backdrop-blur-sm border-t border-base-content/10 px-2 sm:px-4 py-2 sm:py-3 z-10 overflow-x-auto">
            {timelineData}
          </div>
        )}
      </div>
